...
import { handleChange, imageHandleChange, handlePicSubmit } from '../functions.js'
  ...
  return (
    <div>
        <Box component="form" onChange={(e) => handleChange(e, form, setForm)} onSubmit={e => handlePicSubmit(e, handleSubmit, picFile)}>
            ...
            <TextField size='small' variant='standard' name='image' type="file" ref={imageRef} onChange={(e) => imageHandleChange(e, setPicFile, imageRef)} fullWidth label='Image Link'/>
